...
function phosphorusDailyDATA=dailyofePsimTrans(id,day,yr,tstep,tau,hmixprev,mixdepth,ofeArea,kdissolv,stpconc,mewTS,QS,TR,plowday,applnday,applnamt,avalsolPfertprev,lostPfertUP,lostPplntsoilUP,lostPlatUP,avgT,qovlf,qlatf,qperc,sed,sedfrac,ofe)
...
phosphorusDailyDATA=[id,ofe,day,yr,dissolvPnow,lostPfert,lostPplntsoil,lostPeros,lostPlatf,lostPperc];
